...
def ArA_CoLor():
    ...
    Tp = [    
        ...
        "B0E0E6",  # أزرق باهت
        "FFDAB9",  # خوخي فاتح
        "E0FFFF",  # سماوي فاتح جداً
        "F5DEB3",  # قمح فاتح
        "FFC0CB",  # زهري كلاسيكي
        "FFF0F5",  # وردي فاتح جداً
...
def L_DaTa():
    ...
    return map(load, ["_parahex_LiKes.json" , "BesTo_RemaininG_LiKes.json" , "BesTo_RemaininG_Room.json"])
